...
- Agent(subagent_type="Plan"): Strategic decomposition
- Agent(subagent_type="expert-database"): Schema and data design
- Agent(subagent_type="expert-security"): Security architecture
- Agent(subagent_type="expert-backend"): API and service design
- Agent(subagent_type="expert-frontend"): UI implementation
- Agent(subagent_type="manager-quality"): TRUST 5 validation
- Agent(subagent_type="manager-ddd"): DDD implementation cycle
